...
let addEvent = (function(window, undefined) {  //强行模仿jQuery源码 - -
...
let makeSky = (function (doc, window, addEvent) {
    function init() {
        ...
        let cancelREQ = window.cancelRequestAnimationFrame
        ...
        let cvs = doc.getElementById('wrapper-cvs');
        ...
        let stageBack = doc.getElementById('j-stage-block-back'),
            hue = 217,
            stars = [],
        ...
        //缩放窗口触发重计算时会用上的flag
        let flagRestartStar = false;
        let flagRestartSky = false;
        ...
        let synMouseWheel;
        let minAniSpeed = 0.2;
        let ratioAniSpeed = 1 / minAniSpeed;
        let maxAniSpeed = 1;
        let mouseAniSpeed = minAniSpeed;
        ...
        //用来节流的时间戳
        let timestampRunEvent = +new Date();
